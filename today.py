...
PROFILE_UPTIME = os.environ.get('PROFILE_UPTIME', '21 years')
...
if __name__ == '__main__':
    """
    Ishaan Gupta (ishaanxgupta), customized from Andrew6rant/Andrew6rant.
    """
    ...
    age_data, age_time = PROFILE_UPTIME, 0
    formatter('profile uptime', age_time)
